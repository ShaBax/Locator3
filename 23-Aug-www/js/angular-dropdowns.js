...
(function(window, angular) {'use strict';
  ...
  ngDropdowns.run(['$templateCache', function ($templateCache) {
  ...
  ngDropdowns.directive('dropdownSelect', ['DropdownService',
  ...
  ngDropdowns.directive('dropdownSelectItem', [
    function () {
      return {
  ...
  ngDropdowns.directive('dropdownMenu', ['$parse', '$compile', 'DropdownService', '$templateCache',
  ...
  ngDropdowns.directive('dropdownMenuItem', [
    function () {
      return {
  ...
  ngDropdowns.factory('DropdownService', ['$document',
    function ($document) {
